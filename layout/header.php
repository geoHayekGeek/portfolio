    ...
    <div class="socials-button-wrapper">
        ...
        <div class="social-container">
            <div class="social-icon whatsapp">
                <a target="_blank" href="https://wa.me/96176884670">
            ...
            <div class="social-icon instagram">
                <a target="_blank" href="https://www.instagram.com/leanajem99">
                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
        ...
        <div class="socials-toggler clickable">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mobileNav"
                    ...
                    <span class="custom-toggler custom-toggler-1">
                        <svg fill="#000000" width="30px" height="30px" viewBox="0 0 24 24"
                            ...
                            <line x1="3" y1="12" x2="21" y2="12" stroke="#000000" stroke-width="1">
                            </line>
                        </svg>
                    </span>
                    <span class="custom-toggler custom-toggler-2">
                        <svg fill="#000000" width="30px" height="30px" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <line x1="3" y1="12" x2="21" y2="12" stroke="#000000" stroke-width="1">
                            </line>
